...
8 关于ESP8266连接WIFI时，降低功耗要注意的问题，发现ESP8266连接带WIFI的主路由，或二级路由的时候，8266的功耗最低，但是也建议开启WIFI客户端隔离，等隔离功能，目的是降低8266和wifi的通讯数据，比如广播等等没有必要的通信，二图是小电视连接AX6开源固件二级路由器模式时候测试的功率；  
